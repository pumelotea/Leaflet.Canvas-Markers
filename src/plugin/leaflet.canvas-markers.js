    ...
    var CanvasIconLayer = (L.Layer ? L.Layer : L.Class).extend({
        ...
        onRemove: function (map) {
            ...
            if (map._zoomAnimated) {
                ...
                map.off('_zoomend', this._zoomend, this);
            }
        },
        addTo: function (map) {
            map.addLayer(this);
        ...
        _zoomend: function (event){
            this.isAnimateZoom = false
        },
        ...
        _reset: function () {
            ...
            this._canvas.width = size.x * this._devicePixelRatio;
            this._canvas.height = size.y * this._devicePixelRatio;
